...
class ControlPadApp:
    ...
    def __init__(
        ...
        for col in range(3):
            if col == 1:
                ...
                forward_btn.bind(
                    "<Button-3>",
                    lambda e: self._show_power_editor("forward", forward_btn),
                )
            else:
        ...
        left_btn.bind(
            "<Button-3>", lambda e: self._show_power_editor("rotate_left", left_btn)
        )
        ...
        stop_btn1.bind(
            "<Button-3>", lambda e: self._show_power_editor("stop", stop_btn1)
        )
        ...
        right_btn.bind(
            "<Button-3>", lambda e: self._show_power_editor("rotate_right", right_btn)
        )
        ...
        for col in range(3):
            if col == 1:
                ...
                backward_btn.bind(
                    "<Button-3>",
                    lambda e: self._show_power_editor("backward", backward_btn),
                )
            else:
                spacer = tk.Frame(master=movement_grid, width=12 * 7, height=4 * 20)
        ...
        for col in range(3):
            if col == 1:
                ...
                up_btn.bind(
                    "<Button-3>", lambda e: self._show_power_editor("up", up_btn)
                )
            else:
        ...
        rotate_left_btn.bind(
            "<Button-3>",
            lambda e: self._show_power_editor("roll_left", rotate_left_btn),
        )
        ...
        stop_btn2.bind(
            "<Button-3>", lambda e: self._show_power_editor("stop", stop_btn2)
        )
        ...
        rotate_right_btn.bind(
            "<Button-3>",
            lambda e: self._show_power_editor("roll_right", rotate_right_btn),
        )
        ...
        for col in range(3):
            if col == 1:
                ...
                down_btn.bind(
                    "<Button-3>", lambda e: self._show_power_editor("down", down_btn)
                )
            else:
                spacer = tk.Frame(master=rotation_grid, width=12 * 7, height=4 * 20)
                spacer.grid(row=2, column=col, padx=2, pady=2)
        ...
        def on_key_press(button, key: str) -> None:
            ...
            if not pressed_states[key]:
                ...
                if button:
                    ...
                    button.config(
                        relief=tk.SUNKEN, bg=button_colors[color_type]["pressed"]
                    )
        ...
        def on_key_release(button, key: str) -> None:
            ...
            if key in pressed_states and pressed_states[key]:
                ...
                if button:
                    color_type = get_button_color_type(button)
                    button.config(
                        relief=tk.RAISED, bg=button_colors[color_type]["normal"]
                    )
                    button.invoke()
        ...
        self.window.bind(
            f"<KeyRelease-i>", lambda e: on_key_release(rotate_left_btn, "i")
        )

        self.window.bind(f"<KeyPress-k>", lambda e: on_key_press(rotate_right_btn, "k"))
        self.window.bind(
            f"<KeyRelease-k>", lambda e: on_key_release(rotate_right_btn, "k")
        )
        ...
        self.window.bind(
            f"<KeyRelease-l>", lambda e: on_key_release(light_down_btn, "l")
        )
    ...
    def set_light_control_app(
        self, light_control_app: Optional["LightControlApp"]
    ) -> None:
    ...
    def _esc_forward(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("forward") or config.get(
                "control_pad.forward", [-0.15, 0.15, 0.0, 0.10]
            )
    ...
    def _esc_backward(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("backward") or config.get(
                "control_pad.backward", [0.20, -0.20, 0.0, -0.15]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_left(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("rotate_left") or config.get(
                "control_pad.rotate_left", [0.0, 0.0, -0.15, -0.03]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_right(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("rotate_right") or config.get(
                "control_pad.rotate_right", [0.0, 0.0, 0.50, -0.03]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_up(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("up") or config.get(
                "control_pad.up", [0.25, 0.25, 0.0, 0.0]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_down(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("down") or config.get(
                "control_pad.down", [-0.15, -0.15, 0.0, 0.0]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_roll_left(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("roll_left") or config.get(
                "control_pad.roll_left", [0.75, -0.3, 0.0, 0.0]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _esc_roll_right(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("roll_right") or config.get(
                "control_pad.roll_right", [-0.425, 0.6, 0.0, 0.0]
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _stop_escs(self) -> None:
        ...
        if self.esc_control_app:
            power_levels = self.custom_power_levels.get("stop") or config.get(
                "control_pad.stop", [0.0] * self.esc_control_app.num_escs
            )
            self.esc_control_app.send_all_esc_power(power_levels)
    ...
    def _show_power_editor(self, action: str, button: Optional[tk.Button]) -> None:
        ...
        title_label = tk.Label(
            frame, text=f"ESC Power Levels (-1.0 to 1.0)", font=("Arial", 10, "bold")
        )
        ...
        save_btn = tk.Button(
            button_frame, text="Save", command=save_and_close, width=10
        )
        save_btn.pack(side=tk.LEFT, padx=5)

        cancel_btn = tk.Button(
            button_frame, text="Cancel", command=close_popup, width=10
        )
